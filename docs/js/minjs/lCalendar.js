    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.className = "gearArea";
				...
				setTimeout(function(){_self.gearDate.className = "gearArea gearShow";},0);
                dateCtrlInit();
            ...
            function closeMobileCalendar(e) {
				...
				_self.gearDate.className='gearArea'
				setTimeout(function(){document.body.removeChild(_self.gearDate);},310);
            }
            //日期确认
